class BillOfLading < VarlandPdf
    ...
    def insert_header
        ...
        bounding_box [_i(7.25), _i(8.65)], width: _i(1), height: _i(0.25) do
            number_pages 'PAGE <page> OF <total>', align: :right, :size => 9, valign: :top
        end
    ...
    def insertTableData
        bounding_box [_i(0.25), _i(7)], :width => _i(8), :height => _i(3.3), position: :center do
            ...
            table(order_data, :width => (8*72)) do
                style(row(0...-1).columns(0...-1), :align => :center, :borders => [])
